...
if __name__ == '__main__':
    data_root = '/Users/chenjunming/Desktop/DRL_PM/data/processed'
    price_df = pd.read_parquet(f'{data_root}/wide_close_df.parquet')
    open_df = pd.read_parquet(f'{data_root}/wide_open_df.parquet')
    return_df = pd.read_parquet(f'{data_root}/wide_log_return_df.parquet')
    high_df = pd.read_parquet(f'{data_root}/wide_high_df.parquet')
    low_df = pd.read_parquet(f'{data_root}/wide_low_df.parquet')
    vol_df = pd.read_parquet(f'{data_root}/wide_vol_df.parquet')
