...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "data": {
        "root": "data",
        "asset_universe_path": "data/processed/asset_universe.csv",
        "panel_path": "data/processed/etf_lof_daily_panel.parquet",
        "wide_open_path": "data/processed/wide_open.parquet",
        "wide_high_path": "data/processed/wide_high.parquet",
        "wide_low_path": "data/processed/wide_low.parquet",
        "wide_close_path": "data/processed/wide_close.parquet",
        "wide_pre_close_path": "data/processed/wide_pre_close.parquet",
        "wide_pct_chg_path": "data/processed/wide_pct_chg.parquet",
        "wide_log_return_path": "data/processed/wide_log_return.parquet",
        "wide_amount_path": "data/processed/wide_amount.parquet",
        "wide_vol_path": "data/processed/wide_vol.parquet",
        "wide_turnover_rate_path": "data/processed/wide_turnover_rate.parquet",
        "all_metrics_features_path": "data/metrics_factory/all_metrics_features.parquet",
        "download_manifest_path": "data/reports/akshare_etf_lof_download_manifest.json",
        "metrics_manifest_path": "data/reports/metrics_factory_all_features_manifest.json",
        "metrics_factory": {
            "enabled": True,
            "all_metrics_features_path": "data/metrics_factory/all_metrics_features.parquet",
        },
